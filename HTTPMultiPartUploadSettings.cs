...
/// </summary>
namespace HTTPMultiPartUpload
{
    [ORMEntity]
    [DataContract]
    public class HTTPMultiPartUploadSettings : AbstractModuleSettings
    {
        public HTTPMultiPartUploadSettings()
        {
            EntityName = "HTTPMultiPartUpload Custom App Settings";
        }
        ...
        public override BaseActionType[] GetActions(AbstractUserContext userContext, EntityActionType[] types)
        {
            ...
            results.Add(new EditObjectAction(typeof(HTTPMultiPartUploadSettings), "Edit", null, "Edit", ()=> { return this; }, SaveChanges));
